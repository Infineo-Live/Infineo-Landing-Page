        ...
        <div className="footer-top">
          ...
          <nav className="footer-nav">
            <div className="footer-nav-group">
              ...
              <a href="#modules">Ganesha</a>
              <a href="#modules">Hanuman</a>
              <a href="#modules">Krishna</a>
              <a href="#modules">Ramayana</a>
              <a href="#modules">Mahabharata</a>
            </div>
            <div className="footer-nav-group">
              <span className="footer-nav-label">Parents</span>
