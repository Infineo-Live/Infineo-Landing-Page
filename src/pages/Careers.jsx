...
const allRoles = [
  ...
  },
  {
    ...
    icon: "",
    desc: "Help grow INFINEO through outreach, partnerships, and relationship-building initiatives.",
    category: "Internship",
    type: "Internship",
    location: "Remote",
    badge: "3 Months",
    ...
    applyUrl: INTERN_FORM_URL,
    highlights: [
      "Research and identify schools, educators, parent communities, and potential partners",
      "Conduct outreach through email, LinkedIn, WhatsApp, calls, and other channels",
      "Strong communication and relationship-building skills",
      "Must be able to commit consistently for the full internship duration",
    ],
    overview: "We are looking for a Sales & Marketing Intern to help grow INFINEO through outreach, partnerships, and relationship-building initiatives. This role is about proactive communication, daily outreach, and building genuine relationships to expand our student base.",
    responsibilities: [
      "Research and identify schools, educators, parent communities, and potential partners",
      "Conduct outreach through email, LinkedIn, WhatsApp, calls, and other channels",
      "Build and maintain prospect databases and CRM records",
      "Follow up consistently with leads and partners",
      "Support growth, partnership, and awareness campaigns",
      "Track outreach activities and maintain organized records",
      "Help expand INFINEO's reach and student base",
    ],
    requirements: [
      "Strong communication and relationship-building skills",
      "Comfortable initiating conversations and handling rejection",
      "Organised, proactive, and execution-focused",
      "Able to manage multiple conversations and follow-ups",
      "Interest in sales, marketing, business development, or growth",
    ],
    goodToHave: [
      "Experience in outreach, sales, marketing, or community building",
      "Familiarity with LinkedIn, Google Sheets, or CRM tools",
      "Interest in startups, education, or business growth",
    ],
    eligibility: [
      "Open to students, freshers, and self-taught candidates",
      "No strict academic requirements—we value drive and execution",
      "Must be able to commit consistently for the full internship duration",
    ],
    details: {
      Mode: "Remote",
    ...
    benefits: [
      "Certificate of Internship",
      "Experience Letter",
      "Hands-on experience working on real growth initiatives",
      "Mentorship and structured feedback",
      "Opportunity for a full-time role based on performance",
    ],
    note: "This role involves daily outreach, relationship building, and consistent follow-ups. It is best suited for candidates who are proactive, self-driven, and comfortable communicating with new people.",
  },
  {
